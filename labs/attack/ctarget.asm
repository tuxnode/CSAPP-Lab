...
0000000000401eb4 <launch>:
  ...
  401ebf:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28        # !canary
  401ec6:	00 00 
...
0000000000401f61 <stable_launch>:
  ...
  401f7a:	ba 07 00 00 00       	mov    edx,0x7  # 为内存页添加可执行权限
  ...
  401fde:	48 89 e0             	mov    rax,rsp  # 替换栈
  401fe1:	48 89 d4             	mov    rsp,rdx  # 将运行栈替换到新申请的地址
...
00000000004021c9 <urlencode>:
  ...
  4021ee:	f2 ae                	repnz scas al,BYTE PTR [rdi]
...
00000000004022d6 <submitr>:
  ...
  402583:	f3 48 ab             	rep stos QWORD PTR [rdi],rax
  ...
  402666:	f2 ae                	repnz scas al,BYTE PTR [rdi]
  ...
  4029ab:	f3 a6                	repz cmps BYTE PTR [rsi],BYTE PTR [rdi]
