...
0000000000401062 <phase_5>:
  ...
  // 循环体内容 String: maduie
  40108b:	0f b6 0c 03          	movzx  ecx,BYTE PTR [rbx+rax*1] // 从input第一个字节开始读取
  40108f:	88 0c 24             	mov    BYTE PTR [rsp],cl // 字节放置到栈顶
  401092:	48 8b 14 24          	mov    rdx,QWORD PTR [rsp]  // 字节传送到rdx
  401096:	83 e2 0f             	and    edx,0xf   // !取低4位
  401099:	0f b6 92 b0 24 40 00 	movzx  edx,BYTE PTR [rdx+0x4024b0] // 将读取的数字作为偏移量和ascii相加
  4010a0:	88 54 04 10          	mov    BYTE PTR [rsp+rax*1+0x10],dl // 将偏移后的字符传送到
  4010a4:	48 83 c0 01          	add    rax,0x1 // 自增
  4010a8:	48 83 f8 06          	cmp    rax,0x6
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>

  4010ae:	c6 44 24 16 00       	mov    BYTE PTR [rsp+0x16],0x0 // 设置字符串末尾的\0
  4010b3:	be 5e 24 40 00       	mov    esi,0x40245e // "flyers"
  4010b8:	48 8d 7c 24 10       	lea    rdi,[rsp+0x10]  // string起始地址
  4010bd:	e8 76 02 00 00       	call   401338 <strings_not_equal>
  4010c2:	85 c0                	test   eax,eax  // 如果eax是0则跳转
